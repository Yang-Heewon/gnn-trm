...
CKPT_DIR="${CKPT_DIR:-trm_agent/ckpt/cwq_trm_hier6_trm_rel_recursive_phase1_${RUN_TAG}}"
LOG_DIR="${LOG_DIR:-logs/trm_rel_recursive_phase1_${RUN_TAG}}"
WANDB_RUN_NAME="${WANDB_RUN_NAME:-cwq-trm-rel-recursive-phase1-${RUN_TAG}}"
...
FALLBACK_MASTER_PORT="${FALLBACK_MASTER_PORT:-29912}"
...
SUBGRAPH_GNN_VARIANT="${SUBGRAPH_GNN_VARIANT:-trm_rel_recursive}"
SUBGRAPH_RECURSION_STEPS="${SUBGRAPH_RECURSION_STEPS:-3}"
...
echo "[phase1-only] start (trm_rel_recursive tiny-block, final-KL)"
...
echo "[done] trm_rel_recursive phase1 finished"
