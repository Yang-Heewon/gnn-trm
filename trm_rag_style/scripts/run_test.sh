...
SUBGRAPH_TRACE_RELATION_TOPK_ENABLED=${SUBGRAPH_TRACE_RELATION_TOPK_ENABLED:-false}
SUBGRAPH_TRACE_RELATION_TOPK=${SUBGRAPH_TRACE_RELATION_TOPK:-5}
SUBGRAPH_TRACE_LOG_EXAMPLES=${SUBGRAPH_TRACE_LOG_EXAMPLES:-}
SUBGRAPH_TRACE_DUMP_MAX_EXAMPLES=${SUBGRAPH_TRACE_DUMP_MAX_EXAMPLES:-}
if [ -n "${SUBGRAPH_TRACE_MAX_EXAMPLES:-}" ]; then
  SUBGRAPH_TRACE_LOG_EXAMPLES=${SUBGRAPH_TRACE_LOG_EXAMPLES:-$SUBGRAPH_TRACE_MAX_EXAMPLES}
  SUBGRAPH_TRACE_DUMP_MAX_EXAMPLES=${SUBGRAPH_TRACE_DUMP_MAX_EXAMPLES:-$SUBGRAPH_TRACE_MAX_EXAMPLES}
fi
SUBGRAPH_TRACE_LOG_EXAMPLES=${SUBGRAPH_TRACE_LOG_EXAMPLES:-5}
SUBGRAPH_TRACE_DUMP_MAX_EXAMPLES=${SUBGRAPH_TRACE_DUMP_MAX_EXAMPLES:-1000}
SUBGRAPH_TRACE_PATH_DUMP_JSONL=${SUBGRAPH_TRACE_PATH_DUMP_JSONL:-}
...
$PYTHON_BIN -m trm_agent.run \
  ...
  --override \
    ...
    subgraph_trace_relation_topk_enabled="$SUBGRAPH_TRACE_RELATION_TOPK_ENABLED" \
    subgraph_trace_relation_topk="$SUBGRAPH_TRACE_RELATION_TOPK" \
    subgraph_trace_log_examples="$SUBGRAPH_TRACE_LOG_EXAMPLES" \
    subgraph_trace_dump_max_examples="$SUBGRAPH_TRACE_DUMP_MAX_EXAMPLES" \
    subgraph_trace_path_dump_jsonl="$SUBGRAPH_TRACE_PATH_DUMP_JSONL" \
