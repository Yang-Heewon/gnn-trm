...
PHASE1_WANDB_GROUP="${PHASE1_WANDB_GROUP:-${WANDB_GROUP:-${DATASET}-rearev-D-cycle-${RUN_TAG}}}"
...
PHASE2_WANDB_GROUP="${PHASE2_WANDB_GROUP:-${WANDB_GROUP:-${DATASET}-rearev-D-cycle-${RUN_TAG}}}"
...
if [[ "$RUN_PHASE1" == "true" ]]; then
  ...
  WANDB_GROUP="$PHASE1_WANDB_GROUP" \
  ...
  SUBGRAPH_LR_MIN="${PHASE1_SUBGRAPH_LR_MIN:-${SUBGRAPH_LR_MIN:-1e-6}}" \
  SUBGRAPH_LR_STEP_SIZE="${PHASE1_SUBGRAPH_LR_STEP_SIZE:-${SUBGRAPH_LR_STEP_SIZE:-5}}" \
  SUBGRAPH_LR_GAMMA="${PHASE1_SUBGRAPH_LR_GAMMA:-${SUBGRAPH_LR_GAMMA:-0.5}}" \
  SUBGRAPH_LR_PLATEAU_FACTOR="${PHASE1_SUBGRAPH_LR_PLATEAU_FACTOR:-${SUBGRAPH_LR_PLATEAU_FACTOR:-0.5}}" \
  SUBGRAPH_LR_PLATEAU_PATIENCE="${PHASE1_SUBGRAPH_LR_PLATEAU_PATIENCE:-${SUBGRAPH_LR_PLATEAU_PATIENCE:-2}}" \
  SUBGRAPH_LR_PLATEAU_THRESHOLD="${PHASE1_SUBGRAPH_LR_PLATEAU_THRESHOLD:-${SUBGRAPH_LR_PLATEAU_THRESHOLD:-1e-4}}" \
  SUBGRAPH_LR_PLATEAU_METRIC="${PHASE1_SUBGRAPH_LR_PLATEAU_METRIC:-${SUBGRAPH_LR_PLATEAU_METRIC:-dev_hit1}}" \
  DATASET="$DATASET" \
...
WANDB_GROUP="$PHASE2_WANDB_GROUP" \
...
SUBGRAPH_LR_SCHEDULER="${PHASE2_SUBGRAPH_LR_SCHEDULER:-${SUBGRAPH_LR_SCHEDULER:-plateau}}" \
SUBGRAPH_LR_MIN="${PHASE2_SUBGRAPH_LR_MIN:-${SUBGRAPH_LR_MIN:-1e-6}}" \
SUBGRAPH_LR_STEP_SIZE="${PHASE2_SUBGRAPH_LR_STEP_SIZE:-${SUBGRAPH_LR_STEP_SIZE:-5}}" \
SUBGRAPH_LR_GAMMA="${PHASE2_SUBGRAPH_LR_GAMMA:-${SUBGRAPH_LR_GAMMA:-0.5}}" \
SUBGRAPH_LR_PLATEAU_FACTOR="${PHASE2_SUBGRAPH_LR_PLATEAU_FACTOR:-${SUBGRAPH_LR_PLATEAU_FACTOR:-0.7}}" \
