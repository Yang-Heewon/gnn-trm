...
export SUBGRAPH_GNN_VARIANT="${SUBGRAPH_GNN_VARIANT:-rearev_bfs}"
export SUBGRAPH_TRM_REL_TOPK_RELATIONS="${SUBGRAPH_TRM_REL_TOPK_RELATIONS:-0}"
export SUBGRAPH_TRM_REL_SCORE_ALPHA="${SUBGRAPH_TRM_REL_SCORE_ALPHA:-1.0}"
export SUBGRAPH_TRM_REL_USE_RELID_POLICY="${SUBGRAPH_TRM_REL_USE_RELID_POLICY:-true}"
...
export SUBGRAPH_REAREV_ASYM_INNER_Y_EMA_ENABLED="${SUBGRAPH_REAREV_ASYM_INNER_Y_EMA_ENABLED:-false}"
export SUBGRAPH_REAREV_ASYM_INNER_Y_EMA_ALPHA="${SUBGRAPH_REAREV_ASYM_INNER_Y_EMA_ALPHA:-0.0}"
export SUBGRAPH_TRACE_SUPERVISION_ENABLED="${SUBGRAPH_TRACE_SUPERVISION_ENABLED:-false}"
export SUBGRAPH_TRACE_SUPERVISION_EXAMPLES="${SUBGRAPH_TRACE_SUPERVISION_EXAMPLES:-5}"
export SUBGRAPH_TRACE_SUPERVISION_DUMP_JSONL="${SUBGRAPH_TRACE_SUPERVISION_DUMP_JSONL:-}"
export SUBGRAPH_TRACE_SUPERVISION_PLOT_PNG="${SUBGRAPH_TRACE_SUPERVISION_PLOT_PNG:-}"
export SUBGRAPH_DDP_FIND_UNUSED_PARAMETERS="${SUBGRAPH_DDP_FIND_UNUSED_PARAMETERS:-false}"
